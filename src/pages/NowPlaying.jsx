...
export default function NowPlaying() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    tmdbService.getNowPlayingMovies(1).then((data) => {
  ...
  const handleLoadMore = async () => {
    ...
    const data = await tmdbService.getNowPlayingMovies(nextPage);
      ...
      <div className="container-xl" style={{ paddingTop: '40px', paddingBottom: '64px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
            <Clapperboard size={32} color="var(--color-accent)" />
            <h1
              style={{
            ...
            {page < totalPages && (
              <div style={{ textAlign: 'center', marginTop: '48px' }}>
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!loadingMore) e.currentTarget.style.background = 'var(--color-accent-glow-strong)';
                  }}
                  onMouseLeave={(e) => {
                    if (!loadingMore) e.currentTarget.style.background = 'var(--color-accent-glow)';
                  }}
                >
